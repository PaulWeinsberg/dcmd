...
You can also install Docker Desktop on Linux, Docker Engine is included in the Docker Desktop package. [Install Docker Desktop for Linux](https://docs.docker.com/desktop/install/linux-install/).